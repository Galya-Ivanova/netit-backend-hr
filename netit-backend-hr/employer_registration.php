...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
            <form method="POST" name="employer-registration">
                <input class="form-input" type="text" placeholder="Firmname" name="username">
                ...
                <textarea class="form-textarea h-150" placeholder="Description" name="description"></textarea>
