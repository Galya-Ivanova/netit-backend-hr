...
--
-- Dumping data for table `hr_groups`
--

LOCK TABLES `hr_groups` WRITE;
/*!40000 ALTER TABLE `hr_groups` DISABLE KEYS */;
INSERT INTO `hr_groups` VALUES (22,'City',1),(23,'State',1),(24,'Category',1);
/*!40000 ALTER TABLE `hr_groups` ENABLE KEYS */;
UNLOCK TABLES;
