(function() {
    ...
    var baseUrlTransform = function(url) {
        ...
        if(queryParameter) {
            return `http://localhost/netit-backend-hr/_routes.php?endpoint=${endpoint}&method=${method}&${queryParameter}`;
        }
        
        
        if(requestId) {
            return `http://localhost/netit-backend-hr/_routes.php?endpoint=${endpoint}&method=${method}&id=${requestId}`;
        }
        return `http://localhost/netit-backend-hr/_routes.php?endpoint=${endpoint}&method=${method}`;
